...
const moveDivider = (e) => {
  if(e.srcElement.id == "option-1"){
    divider.style.marginLeft = "8vw"
    divider.style.marginRight = 0
  }else if(e.srcElement.id == "option-2"){
    divider.style.marginLeft = 0
    divider.style.marginRight = "8vw"
  }
}

document.addEventListener("mousemove", throttle(moveDivider, 100))
...
options.forEach((option) => {
  option.addEventListener("click", (e) => {
    options.forEach((otherOption) => {
      ...
      if(e.target !== otherOption) {
        otherOption.style.flex = 0;
        otherOption.style.width = 0;
        otherOption.style.padding = 0;
...
(function($) {
  $.confetti = new function() {
    ...
    function init() {
        SetGlobals();
        $(".option").click(InitializeConfetti);
